...
public class ExemplaireViewConsole extends AbstractView<Exemplaire> {
    ...
    private void louer(Exemplaire a) {
        ...
        System.out.println("Choose a lecteur:");
        List<Lecteur> ll = GestionMVC.lv.getAll();
        int ch = choixListe(ll);
        Lecteur chosenLecteur = ll.get(ch-1);
        GestionMVC.LOCATIONS.put(a, chosenLecteur);
        System.out.println("Location recorded for exemplaire: " + a.getMatricule() + ", lecteur: " + chosenLecteur.getNumlecteur());
    }
